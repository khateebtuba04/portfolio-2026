      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        ...
        >
          ...
          >
            ...
            <h1 className="font-shrikhand text-ink-black text-2xl md:text-2xl lg:text-3xl leading-[0.9] tracking-tight mb-8 drop-shadow-sm transition-transform duration-700 group-hover:translate-x-2 whitespace-nowrap">
              ABOUT <span className="text-tomato-jam">ME.</span>
            </h1>

            <h2 
              className="font-shrikhand text-2xl md:text-2xl lg:text-3xl leading-tight mb-10 text-ink-black"
            ...
            <p className="text-gray-800 font-sans font-medium text-lg md:text-xl leading-relaxed max-w-2xl group-hover:text-ink-black transition-colors duration-700">
          ...
          >
            ...
            <div className="flex flex-col justify-center items-center text-center p-10 lg:p-12 bg-ink-black rounded-[32px] shadow-lg hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] transition-all duration-500 hover:-translate-y-1 mt-4">
              <h3 className="font-shrikhand text-almond-cream text-xl md:text-2xl mb-4 leading-tight">
                "Data is the new oil,
              </h3>
              <p className="font-shrikhand text-tomato-jam text-xl md:text-2xl">
